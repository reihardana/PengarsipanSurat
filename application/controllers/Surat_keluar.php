...
class Surat_keluar extends CI_Controller
{
    ...
    {
        $surat_keluar = $this->Surat_keluar_model->get_all();

        $data = array(
            'surat_keluar_data' => $surat_keluar
        );

        $this->template->load('template','surat_keluar_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'pengirim' => $row->pengirim,
            ...
            $this->template->load('template','surat_keluar_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','surat_keluar_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('surat_keluar_doc',$data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-01-17 03:34:50 */
/* http://harviacode.com */