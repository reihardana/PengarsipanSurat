...
class Surat_masuk extends CI_Controller
{
    ...
    {
        $surat_masuk = $this->Surat_masuk_model->get_all();

        $data = array(
            'surat_masuk_data' => $surat_masuk
        );

        $this->template->load('template','surat_masuk_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'penerima' => $row->penerima,
            ...
            $this->template->load('template','surat_masuk_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','surat_masuk_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('surat_masuk_doc',$data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-01-17 03:34:55 */
/* http://harviacode.com */